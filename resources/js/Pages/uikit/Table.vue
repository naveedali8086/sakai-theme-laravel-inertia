            ...
            <div class="card">
                ...
                >
                    ...
                    <Column header="Country" filterField="country.name" style="min-width: 12rem">
                        <template #body="{ data }">
                            <img :src="`${baseUrl}/demo/images/flag/flag_placeholder.png`" :alt="data.country.name" :class="'flag flag-' + data.country.code" width="30" />
            ...
            <div class="card">
                ...
                <DataTable :value="customer2" :scrollable="true" scrollHeight="400px" :loading="loading2" scrollDirection="both" class="mt-3">
                    ...
                    <Column field="country.name" header="Country" :style="{ width: '200px' }">
                        <template #body="{ data }">
                            <img :src="`${baseUrl}/demo/images/flag/flag_placeholder.png`" :class="'flag flag-' + data.country.code" width="30" />
                            <span style="margin-left: 0.5em; vertical-align: middle" class="image-text">{{ data.country.name }}</span>
                        </template>
                    </Column>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable :value="products" v-model:expandedRows="expandedRows" dataKey="id" responsiveLayout="scroll">
                    ...
                    <Column header="Image">
                        <template #body="slotProps">
                            <img :src="`${baseUrl}/demo/images/product/${slotProps.data.image}`" :alt="slotProps.data.image" class="shadow-2" width="100" />
                        </template>
                    </Column>
            ...
            <div class="card">
                ...
                <DataTable :value="customer3" rowGroupMode="subheader" groupRowsBy="representative.name" sortMode="single" sortField="representative.name" :sortOrder="1" scrollable scrollHeight="400px">
                    ...
                    <Column field="country" header="Country" style="min-width: 200px">
                        <template #body="slotProps">
                            <img :src="`${baseUrl}/demo/images/flag/flag_placeholder.png`" :class="'flag flag-' + slotProps.data.country.code" width="30" />
