...
const baseUrl = (new BaseService()).getBaseUrl();
    ...
    <div class="grid">
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <AvatarGroup class="mb-3">
                    <Avatar :image="`${baseUrl}/demo/images/avatar/amyelsner.png`" size="large" shape="circle"></Avatar>
                    <Avatar :image="`${baseUrl}/demo/images/avatar/asiyajavayant.png`" size="large" shape="circle"></Avatar>
                    <Avatar :image="`${baseUrl}/demo/images/avatar/onyamalimba.png`" size="large" shape="circle"></Avatar>
                    <Avatar :image="`${baseUrl}/demo/images/avatar/ionibowcher.png`" size="large" shape="circle"></Avatar>
                    <Avatar :image="`${baseUrl}/demo/images/avatar/xuxuefeng.png`" size="large" shape="circle"></Avatar>
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <h5>Image</h5>
                <div class="flex align-items-center flex-column sm:flex-row">
                    <Chip label="Amy Elsner" :image="`${baseUrl}/demo/images/avatar/amyelsner.png`" class="mr-2 mb-2"></Chip>
                    <Chip label="Asiya Javayant" :image="`${baseUrl}/demo/images/avatar/asiyajavayant.png`" class="mr-2 mb-2"></Chip>
                    <Chip label="Onyama Limba" :image="`${baseUrl}/demo/images/avatar/onyamalimba.png`" class="mr-2 mb-2"></Chip>
                </div>
            </div>
